...
public class ReceiveMailServiceImpl implements ReceiveMailService {
  ...
  public void handleReceivedMail(MimeMessage receivedMessage) {
    try {
      System.out.println("##############handleReceivedMail.....");
              ...
              message -> {
                ...
                try {
                  return currentMessage
                      .getMessageID()
                      .equalsIgnoreCase(receivedMessage.getMessageID());
  ...
  private void copyMailToDownloadedFolder(MimeMessage mimeMessage, Folder folder)
        ...
        .forEach(
            dataSource -> {
              if (StringUtils.isNotBlank(dataSource.getName())) {
                ...
                String downloadedAttachmentFilePath =
                    rootDirectoryPath
                        + File.separator
                        + DOWNLOAD_FOLDER
                        + File.separator
